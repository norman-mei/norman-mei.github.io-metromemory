...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[932], {
		7932: function(e, t, r) {
			...
			let v = (0, x.Z)({
				en: {
					...
					congrats: e => {
						...
						return `Well done, you reached ${10*Math.floor(100*t/10)}%!`
					},
					...
					supportWithDonation: e => {
						...
						return (0, a.jsxs)("span", {
							children: ["Support the development of ", (0, a.jsx)("strong", {
								children: t
							}), " by making a donation."]
						})
					},
					opensANewTab: "This link will open a new tab and your progress is saved in your browser.",
			...
			let P = {
					default: e => e,
					berlin: e => e.replace(/straße/g, "str").replace(/strasse/g, "str").replace(/ und /g, " ").replace(/ & /g, " ").replace(/ß/g, "ss"),
					hamburg: e => e.replace(/straße/g, "str").replace(/strasse/g, "str").replace(/ und /g, " ").replace(/ & /g, " ").replace(/hbf/g, "hauptbahnhof").replace(/ß/g, "ss"),
					muenchen: e => e.replace(/straße/g, "str").replace(/strasse/g, "str").replace(/ und /g, " ").replace(/ & /g, " ").replace(/hbf/g, "hauptbahnhof").replace(/ß/g, "ss").replace(/saint /g, "st "),
					london: e => e.replace(/street/g, "st").replace(/ road/g, " rd").replace(/saint /g, "st ").replace(/ and /g, " ").replace(/ & /g, " "),
					wien: e => e.replace(/ß/g, "ss").replace(/strasse/g, "str").replace(/gasse/g, "g").replace(/sankt/g, "st").replace(/platz/g, "pl").replace(/bahnhof/g, "bhf").replace(/ und /g, " ").replace(/ & /g, " "),
					dc: e => e.replace(/street/g, "st").replace(/ avenue/g, " av").replace(/ ave/g, " av").replace(/ heights/g, " hts").replace(/ road/g, " rd").replace(/ parkway/g, " pkwy").replace(/ square/g, " sq").replace(/ junction/g, " jct").replace(/ place/g, " pl").replace(/ center/g, " ctr").replace(/ boulevard/g, " blvd").replace(/ south west/g, " sw").replace(/ east/g, " e").replace(/george mason university/g, "gmu").replace(/george washington university/g, "gwu").replace(/north of massachusetts avenue/g, " noma").replace(/university of maryland/g, " u of md").replace(/ university/g, " u").replace(/saint /g, "st ").replace(/mount /g, "mt ").replace(/iad/g, "dulles airport").replace(/dca/g, "reagan airport").replace(/th /g, " ").replace(/1st /g, "1 ").replace(/2nd /g, "2 ").replace(/3rd /g, "3 ").replace(/east /g, "e ").replace(/west /g, "o ").replace(/north /g, "n ").replace(/south /g, "s ").replace(/ and /g, " ").replace(/ & /g, " "),
					chicago: e => e.replace(/street/g, "st").replace(/ avenue/g, " av").replace(/ ave/g, " av").replace(/ heights/g, " hts").replace(/ road/g, " rd").replace(/ parkway/g, " pkwy").replace(/ square/g, " sq").replace(/ junction/g, " jct").replace(/ place/g, " pl").replace(/ center/g, " ctr").replace(/ boulevard/g, " blvd").replace(/ south west/g, " sw").replace(/ east/g, " e").replace(/ and /g, " ").replace(/ & /g, " "),
					boston: e => e.replace(/saint/g, "st").replace(/street/g, "st").replace(/ avenue/g, " av").replace(/ ave/g, " av").replace(/ heights/g, " hts").replace(/ road/g, " rd").replace(/ parkway/g, " pkwy").replace(/ square/g, " sq").replace(/ junction/g, " jct").replace(/ place/g, " pl").replace(/ center/g, " ctr").replace(/ boulevard/g, " blvd").replace(/ south west/g, " sw").replace(/ east/g, " e").replace(/ and /g, " ").replace(/ & /g, " ").replace(/bu /g, "boston university "),
					ny: e => e.replace(/street/g, "st").replace(/ avenue/g, " av").replace(/ ave/g, " av").replace(/ heights/g, " hts").replace(/ road/g, " rd").replace(/ parkway/g, " pkwy").replace(/ square/g, " sq").replace(/ drive/g, " dr").replace(/ junction/g, " jct").replace(/ place/g, " pl").replace(/ center/g, " ctr").replace(/ boulevard/g, " blvd").replace(/new york university/g, "nyu").replace(/new york/g, "ny").replace(/airport/g, "").replace(/washington/g, "wash").replace(/brooklyn/g, "blkyn").replace(/saint /g, "st ").replace(/mount /g, "mt ").replace(/first /g, "1 ").replace(/second /g, "2 ").replace(/third /g, "3 ").replace(/fourth /g, "4 ").replace(/fifth /g, "5 ").replace(/sixth /g, "6 ").replace(/seventh /g, "7 ").replace(/eighth /g, "8 ").replace(/ninth /g, "9 ").replace(/tenth /g, "10 ").replace(/eleventh /g, "11 ").replace(/twelfth /g, "12 ").replace(/thirteenth /g, "13 ").replace(/fourteenth /g, "14 ").replace(/fifteenth /g, "15 ").replace(/sixteenth /g, "16 ").replace(/seventeenth /g, "17 ").replace(/eighteenth /g, "18 ").replace(/nineteenth /g, "19 ").replace(/twentieth /g, "20 ").replace(/th /g, " ").replace(/1st /g, "1 ").replace(/2nd /g, "2 ").replace(/3rd /g, "3 ").replace(/east /g, "e ").replace(/west /g, "w ").replace(/north /g, "n ").replace(/south /g, "s ").replace(/ and /g, " ").replace(/ & /g, " "),
					barcelona: e => e.replace(/carrer/g, "c").replace(/calle/g, "c").replace(/avinguda/g, "av").replace(/placa/g, "pl").replace(/plaça/g, "pl").replace(/passeig/g, "pg").replace("/sant /g", "st ").replace(/rambla/g, "rbla"),
					seoul: e => e.toLowerCase().replace(/\([^()]*\)/g, "").replace("university", "univ").replace("international", "intl").replace("national", "natl").replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, " ").replace(/\s+/g, " ").trim(),
					tokyo: e => e.toLowerCase().replace(/\([^()]*\)/g, "").replace(/\([^<>]*\)/g, "").replace(/\([^〈〉]*\)/g, "").replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, " ").replace(/\s+/g, " ").trim()
				},
				L = e => P[e] || P.default,
				E = e => {
									...
									children: (0, a.jsxs)(h.V.Panel, {
										...
										children: [(0, a.jsx)("div", {
											children: (0, a.jsx)("div", {
												...
												children: (0, a.jsx)(h.V.Title, {
													as: "h3",
													className: "text-left text-base font-bold leading-6 text-gray-900",
													children: i("congrats", {
														foundProportion: n
													})
												})
											...
											children: [(0, a.jsx)("p", {
												...
												children: i("supportWithDonation", {
													title: o.title
												})
											}), (0, a.jsx)("p", {
												className: "mb-2 text-xs text-gray-700",
												children: i("opensANewTab")
											}), (0, a.jsx)("a", {
												rel: "noreferrer",
												target: "_blank",
												href: l,
